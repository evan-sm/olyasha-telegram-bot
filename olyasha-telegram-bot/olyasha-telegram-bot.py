...
def echo(bot, update):
    ...
    update.message.reply_text(update.message.text  + str(update.message.chat_id))
...
def main():
    ...
    dp.add_handler(CommandHandler("help", help, filters=Filters.user(username='@wmwofficial')))
